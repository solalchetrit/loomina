...
const STEPS = [
  {
    chapter: "1",
    title: "L'Inscription",
    description: "Tout commence par une simple commande. Vous recevez votre Carte Membre Loomina et l'accès à votre espace personnel.",
    icon: (
  ...
  },
  {
    ...
    description: "À votre rythme, vous échangez par téléphone avec Loomina. Elle vous écoute, vous guide et ravive vos souvenirs oubliés.",
    icon: (
      <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6">
