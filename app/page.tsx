...
export default function Home() {
  return (
    <div className="min-h-screen w-full flex flex-col items-center bg-[var(--background)] text-[var(--loomina-black)]">
      ...
      <section className="w-full bg-[var(--loomina-gray-light)] py-20 px-6" id="faq">
        <div className="max-w-5xl mx-auto flex flex-col items-center gap-8">
          <div className="text-center space-y-3">
            <p className="text-sm uppercase tracking-[0.2em] text-[var(--loomina-gold)] font-semibold">FAQ</p>
            <h2 className="text-3xl md:text-4xl font-semibold leading-tight text-[var(--loomina-black)]">
              Tout ce qu'il faut savoir avant de commencer
            </h2>
            <p className="text-[var(--loomina-black)] max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="w-full bg-[var(--loomina-gray-light)] text-[var(--loomina-black)] py-16 px-6 border-t border-[var(--loomina-black)]/10">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-[2fr,1fr] gap-8 items-center">
          ...
          <div className="flex flex-col gap-3">
            ...
            <span className="text-[var(--loomina-black)] text-sm text-center">Réponse en moins de 24h</span>
          </div>
        </div>
      </section>
    </div>
