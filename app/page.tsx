...
export default function Home() {
  return (
    <div className="w-full bg-white text-[var(--loomina-ink)]">
      ...
      <section className="w-full bg-white px-6 py-16 md:py-20" id="comment">
        <div className="mx-auto flex max-w-5xl flex-col gap-10 text-center">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {steps.map((step) => (
              <div
                key={step.title}
                className="flex h-full flex-col gap-4 rounded-3xl border border-black/5 bg-[var(--loomina-gray-light)] px-6 py-8 text-left shadow-sm"
              >
                <div className="flex items-center justify-between text-sm font-semibold text-neutral-600">
                  <span className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-1 text-[11px] uppercase tracking-[0.18em] border border-black/5">
                    {step.title}
                  </span>
                  <span className="h-2 w-2 rounded-full bg-[var(--loomina-amber-strong)]" />
                </div>
                <p className="text-base leading-relaxed text-neutral-700">{step.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="w-full bg-[var(--loomina-gray-light)] px-6 py-16 md:py-20" id="exemple-audio">
      ...
      <section className="w-full bg-[var(--loomina-gray-light)] px-6 py-16 md:py-20" id="contact">
        <div className="mx-auto flex max-w-4xl flex-col gap-6 rounded-3xl border border-black/5 bg-white p-8 text-center shadow-sm">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <a
              ...
              className="inline-flex items-center justify-center rounded-full bg-[var(--loomina-black)] px-6 py-3 text-sm font-semibold text-white shadow-[0_18px_50px_-36px_rgba(0,0,0,0.45)] transition hover:-translate-y-[1px]"
            >
              Appeler l'équipe Loomina
            </a>
            <a
              href="mailto:contact@loomina.fr?subject=Organiser%20un%20appel%20Loomina"
              className="inline-flex items-center justify-center rounded-full border border-black/10 bg-white px-6 py-3 text-sm font-semibold text-[var(--loomina-ink)] transition hover:-translate-y-[1px] hover:shadow-md"
            >
              Écrire à l'équipe
            </a>
          </div>
