...
export default function Home() {
  return (
    <div className="min-h-screen w-full flex flex-col items-center bg-[var(--background)] text-[var(--loomina-text)]">
      ...
      <section className="w-full bg-[var(--loomina-cream)] py-20 px-6 relative overflow-hidden" id="faq">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,rgba(242,93,122,0.12),transparent_35%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_75%_20%,rgba(43,183,163,0.14),transparent_28%)]" />
        <div className="relative max-w-5xl mx-auto flex flex-col items-center gap-8">
          <div className="text-center space-y-3">
            ...
            <h2 className="text-3xl md:text-4xl font-semibold leading-tight text-[var(--loomina-text)]">
      ...
      <section className="w-full bg-gradient-to-r from-[#ffe5da] via-[#fff3ec] to-[#e9fbf5] text-[var(--loomina-text)] py-16 px-6 border-t border-[var(--loomina-burgundy)]/10">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-[2fr,1fr] gap-8 items-center">
          ...
          <div className="flex flex-col gap-3">
            <a
              href="#comment"
              className="inline-flex items-center justify-center px-5 py-3 rounded-full bg-[var(--loomina-burgundy)] text-white font-semibold shadow-[0_20px_60px_-35px_rgba(217,54,98,0.55)] hover:bg-[var(--loomina-burgundy-dark)] transition-colors"
            >
