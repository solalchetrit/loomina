...
export default function Home() {
  return (
    <div className="min-h-screen w-full flex flex-col items-center bg-[var(--background)] text-[var(--loomina-text)]">
      ...
      <section className="w-full bg-[var(--loomina-cream)] py-20 px-6" id="faq">
        <div className="max-w-5xl mx-auto flex flex-col items-center gap-8">
          <div className="text-center space-y-3">
            ...
            <p className="text-[var(--loomina-text)] max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="w-full bg-[var(--loomina-cream)] text-[var(--loomina-text)] py-16 px-6 border-t border-[var(--loomina-burgundy)]/10">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-[2fr,1fr] gap-8 items-center">
          ...
          <div className="flex flex-col gap-3">
            <a
              href="#comment"
              className="inline-flex items-center justify-center px-5 py-3 rounded-full bg-[var(--loomina-burgundy)] text-white font-semibold shadow-[0_20px_60px_-35px_rgba(217,54,98,0.55)] hover:brightness-110 transition-colors"
            >
              Planifier une session découverte
            </a>
            <span className="text-[var(--loomina-text)] text-sm text-center">Réponse en moins de 24h</span>
          </div>
        </div>
      </section>
    </div>
