                    ...
                    >
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div className="flex-shrink-0 w-6 h-6 rounded-full border border-[var(--loomina-gold)] text-[var(--loomina-gold)] flex items-center justify-center text-sm font-bold group-hover:bg-[var(--loomina-gold)] group-hover:text-white transition-colors">
                                    ?
                                </div>
